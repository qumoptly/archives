...
function(t, n, e) {
    ...
    a = function(t, n, e) {
        ...
        for (s in v && (e = n), e) l = ((f = !d && b && void 0 !== b[s]) ? b: e)[s],
...
function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, h, y, m) {
        ...
        if (E && (g = f(E.call(new t))) !== Object.prototype && g.next && (s(g, _, !0), r || "function" == typeof g[l] || c(g, l, d)), P && S && "values" !== S.name && (O = !0, k = function() {
            return S.call(this)
        }), r && !m || !p && !O && j[l] || c(j, l, k), u[n] = k, u[_] = d, h) if (b = {
            values: P ? k: x("values"),
            keys: y ? k: x("keys"),
            entries: T
        },
        m) for (w in b) w in j || i(j, w, b[w]);
...
function(t, n, e) {
    ...
    f.addEventListener("message", w, !1)) : r = "onreadystatechange" in s("script") ?
    function(t) {
...
function(t, n, e) {
    ...
    f = new(function(t) {
        ...
        o(n, [{
            ...
            default.mobile() || e.e(0).then(e.bind(null, 79)).then(function(n) { (s = n).theRealInit(t)
                }).
                catch(function(t) {
                    console.error(t)
                })
...
function(t, n, e) {
    ...
    function(t, n) {
        var e;
        return null !== t ? (u.prototype = r(t), e = new u, u.prototype = null, e[c] = t) : e = a(),
        void 0 === n ? e: o(e, n)
    }
},
function(t, n, e) {
...
function(t, n, e) {
    ...
    H = function(t) {
        ...
        if (!e._d) {
            ...
            e = e._w || e;
            try {
                if (e === t) throw P("Promise can't be resolved itself"); (n = A(t)) ? b(function() {
                    var r = {
                        _w: e,
                        _d: !1
                    };
