...
webpackJsonpL2Dwidget([0], {
    79 : function(t, e, i) {
        ...
        function M(t) {
            ...
            } else "mouseleave" == t.type && E()
        }
        function x(t) {
            var e, i, r, o, s, a, _, h = t.touches[0];
            "touchstart" == t.type ? 1 == t.touches.length && L(h) : "touchmove" == t.type ? (e = h, i = n.currCanvas.getBoundingClientRect(), r = I(e.clientX - i.left), o = D(e.clientY - i.top), s = S({
                x: i.left + i.width / 2,
                y: i.top + i.height * v
            },
            {
            ...
            i), a = A(s.x - i.left), _ = w(s.y - i.top), l.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + e.clientX + " y:" + e.clientY + " ) view( x:" + a + " y:" + _ + ")"), P && (r, o, y.setPoint(a, _))) : "touchend" == t.type && E()
        }
        function A(t) {
        ...
        e.theRealInit = function() { (0, n.createElement)(),
            n.currCanvas.addEventListener && (window.addEventListener("click", M), window.addEventListener("mousedown", M), window.addEventListener("mousemove", M), window.addEventListener("mouseup", M), document.addEventListener("mouseleave", M), window.addEventListener("touchstart", x), window.addEventListener("touchend", x), window.addEventListener("touchmove", x)),
            ...
            v = -r,
            S = r; (d = new a.L2DViewMatrix).setScreenRect($, P, v, S),
        ...
        "use strict"; (function(t) {
            ...
            r._$62 = function(t, e) {
                try {
                    ...
                    if (i = o._$ST(), o._$gr(i), i > G._$T7) throw t._$NP |= r._$4s,
                ...
                if (0 != i) if (1 == t.length) {
                    ...
                    for (u = 0; u < t.length; u++) {
                        ...
                        if (o == u) s.setPartsOpacity(c, n);
                            ...
                            var l, $ = s.getPartsOpacity(c); (1 - (l = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (l = 1 - .15 / (1 - n)),
                            $ > l && ($ = l),
                            s.setPartsOpacity(c, $)
                        }
                    }
            ...
            o.prototype.calcClippedDrawTotalBounds = function(t, e) {
                for (var i = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = i > r ? i: r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
                    ...
                    u = t._$C2($);
                    if (u._$yo()) {
                        for (var p = u.getTransformedPoints(), c = p.length, f = [], g = [], y = 0, d = B._$i2; d < c; d += B._$No) f[y] = p[d],
                        g[y] = p[d + 1],
                        y++;
            ...
            function A() {}
            function w() {
                i || (this._$VP = 0, this._$wL = null, this._$GP = null, this._$8o = w._$ds, this._$2r = -1, this._$O2 = 0, this._$ri = 0)
            }
            function I() {}
            function D() {
                i || (this._$Ob = null)
            ...
            v._$Vr = function(t, e, i, r, o, n, s, a) {
                ...
                if (_ <= 0) {
                    ...
                    v = b * g,
                    S = b * m;
                    for (c = 0; c < $;) n[u] = T * p[c] + P * f[c] + v * y[c] + S * d[c],
                    ++c,
                    ...
                    U = st * b * g,
                    Y = st * b * m;
                    for (c = 0; c < $;) n[u] = R * L[c] + F * E[c] + C * M[c] + N * x[c] + B * w[c] + G * I[c] + U * D[c] + Y * O[c],
                    ++c,
                    ...
                    St = at * st * b * g,
                    Lt = at * st * b * m;
                    for (c = 0; c < $;) n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + vt * rt[c] + St * ot[c] + Lt * nt[c],
                    ++c,
                    ...
                    for (var Et = 1 << _,
                    Mt = new Float32Array(Et), xt = 0; xt < Et; xt++) {
                        for (var At = xt,
                        wt = 1,
                        It = 0; It < _; It++) wt *= At % 2 == 0 ? 1 - l[It] : l[It],
                        At /= 2;
                        Mt[xt] = wt
                    }
                    ...
                    for (c = 0; c < $;) {
                        ...
                        Rt = 0,
                        Ft = c + 1;
                        for (Ot = 0; Ot < Et; Ot++) bt += Mt[Ot] * Dt[Ot][c],
                        Rt += Mt[Ot] * Dt[Ot][Ft];
                        c += 2,
                        n[u] = bt,
                        n[u + 1] = Rt,
            ...
            I.startsWith = function(t, e, i) {
                ...
                for (var o = e; o < r; o++) if (I.getChar(t, o) != i.charAt(o - e)) return ! 1;
                return ! 0
            },
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                            ...
                            if (l >= 0) {
                                var s = new N;
                                I.startsWith(t, h, F._$cs) ? (s._$RP = N._$hs, s._$4P = new String(t, h, l - h)) : I.startsWith(t, h, F._$ar) ? (s._$4P = new String(t, h + 7, l - h - 7), I.startsWith(t, h + 7, "ANCHOR_X") ? s._$RP = N._$xs: I.startsWith(t, h + 7, "ANCHOR_Y") ? s._$RP = N._$us: I.startsWith(t, h + 7, "SCALE_X") ? s._$RP = N._$qs: I.startsWith(t, h + 7, "SCALE_Y") ? s._$RP = N._$Ys: I.startsWith(t, h + 7, "X") ? s._$RP = N._$ws: I.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns)) : (s._$RP = N._$Fr, s._$4P = new String(t, h, l - h)),
                                e.motions.push(s);
                                var a = 0;
            ...
            U.prototype.init = function() {
                ...
                y = yt._$2o();;) {
                    ...
                    for (s = 0; s < g; ++s) {
                        var m = r[s];
                        if (null != m) {
                            var T = m.getTargetBaseDataID(); (null == T || T == y || this.getBaseDataIndex(T) >= 0) && (this._$3S.push(m), this._$db.push(n[s]), r[s] = null, d = !0)
                        }
                    }
                    if (!d) break
                }
            ...
            var V = function() {};
            function X() {
                i || (E.prototype.constructor.call(this), this._$sb = new Int32Array(X._$As), this._$U2 = new Array, this.transform = null, this.gl = null, null == X._$NT && (X._$NT = X._$9r(256), X._$vS = X._$9r(256), X._$no = X._$vb(256)))
            }
            function z() {
            ...
            function pt(t) {
                i || (r.prototype.constructor.call(this), this.drawParamWebGL = new dt(t), this.drawParamWebGL.setGL(at.getGL(t)))
            }
            function ct() {
            ...
            z.prototype._$nb = function(t, e, i, r, o, n, s) {
                this != e._$GT() && console.log("### assert!! ### ");
                for (var a, _, h = e,
                l = null != h._$Wr ? h._$Wr: h._$Yr, $ = Math.sin(St._$bS * l._$qT), u = Math.cos(St._$bS * l._$qT), p = h.getTotalScale(), c = l.reflectX ? -1 : 1, f = l.reflectY ? -1 : 1, g = u * p * c, y = -$ * p * f, d = $ * p * c, m = u * p * f, T = l._$fL, P = l._$gL, v = o * s, S = n; S < v; S += s) a = i[S],
                _ = i[S + 1],
                r[S] = g * a + y * _ + T,
                r[S + 1] = d * a + m * _ + P
            },
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                            ...
                            if (u >= 0) {
                                var a = new N;
                                I.startsWith(t, $, J._$cs) ? (a._$RP = N._$hs, a._$4P = I.createString(t, $, u - $)) : I.startsWith(t, $, J._$ar) ? (a._$4P = I.createString(t, $ + 7, u - $ - 7), I.startsWith(t, $ + 7, "ANCHOR_X") ? a._$RP = N._$xs: I.startsWith(t, $ + 7, "ANCHOR_Y") ? a._$RP = N._$us: I.startsWith(t, $ + 7, "SCALE_X") ? a._$RP = N._$qs: I.startsWith(t, $ + 7, "SCALE_Y") ? a._$RP = N._$Ys: I.startsWith(t, $ + 7, "X") ? a._$RP = N._$ws: I.startsWith(t, $ + 7, "Y") && (a._$RP = N._$Ns)) : (a._$RP = N._$Fr, a._$4P = I.createString(t, $, u - $)),
                                e.motions.push(a);
                                var _ = 0,
                                h = [];
                                for (o = u + 1; o < r && ("\r" != (n = Q(t, o)) && "\n" != n); ++o) if ("," != n && " " != n && "\t" != n) {
            ...
            Z.transformPoints_sdk2 = function(e, i, r, o, n, s, a, _) {
                ...
                T = o; T < u; T += n) {
                    ...
                    if (S = e[T], v = (L = e[T + 1]) * _, (P = S * a) < 0 || v < 0 || a <= P || _ <= v) {
                        ...
                        if ( - 2 < S && S < 3 && -2 < L && L < 3) if (S <= 0) if (L <= 0) {
                            var I = s[2 * (0 + 0 * E)],
                            D = s[2 * (0 + 0 * E) + 1],
                            O = p - 2 * f,
                            b = c - 2 * g,
                            ...
                            F = c - 2 * d,
                            C = p - 2 * f - 2 * y,
                            N = c - 2 * g - 2 * d; (B = .5 * (S - -2)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else if (L >= 1) {
                            R = s[2 * (0 + _ * E)],
                            F = s[2 * (0 + _ * E) + 1],
                            C = p - 2 * f + 1 * y,
                            ...
                            D = c + 3 * d,
                            O = p - 2 * f + 3 * y,
                            b = c - 2 * g + 3 * d; (B = .5 * (S - -2)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else { (k = 0 | v) == _ && (k = _ - 1);
                            var B = .5 * (S - -2),
                            G = v - k,
                            U = k / _,
                            ...
                            N = c + 1 * g - 2 * d,
                            R = p + 3 * f - 2 * y,
                            F = c + 3 * g - 2 * d; (B = .5 * (S - 1)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else if (L >= 1) {
                            C = s[2 * (a + _ * E)],
                            N = s[2 * (a + _ * E) + 1],
                            R = p + 3 * f + 1 * y,
                            ...
                            b = c + 1 * g + 3 * d,
                            I = p + 3 * f + 3 * y,
                            D = c + 3 * g + 3 * d; (B = .5 * (S - 1)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else {
                            var k; (k = 0 | v) == _ && (k = _ - 1);
                            B = .5 * (S - 1),
                            G = v - k,
                        ...
                        i[T + 1] = c + S * g + L * d
                    } else h = 2 * ((0 | P) + (0 | v) * (a + 1)),
                    (l = P - (0 | P)) + ($ = v - (0 | v)) < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $, i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (a + 1) + 1] * $) : (i[T] = s[h + 2 * (a + 1) + 2] * (l - 1 + $) + s[h + 2 * (a + 1)] * (1 - l) + s[h + 2] * (1 - $), i[T + 1] = s[h + 2 * (a + 1) + 3] * (l - 1 + $) + s[h + 2 * (a + 1) + 1] * (1 - l) + s[h + 3] * (1 - $))
                }
            },
            Z.prototype.transformPoints_sdk1 = function(t, e, i, r, o, n, s) {
                ...
                g = this._$A,
                y = o * s,
                d = null != c._$hr ? c._$hr: c._$Cr, m = n; m < y; m += s) at._$ts ? (a = i[m], _ = i[m + 1], a < 0 ? a = 0 : a > 1 && (a = 1), _ < 0 ? _ = 0 : _ > 1 && (_ = 1), l = 0 | (_ *= g), (h = 0 | (a *= f)) > f - 1 && (h = f - 1), l > g - 1 && (l = g - 1), u = a - h, p = _ - l, $ = 2 * (h + l * (f + 1))) : (u = (a = i[m] * f) - (0 | a), p = (_ = i[m + 1] * g) - (0 | _), $ = 2 * ((0 | a) + (0 | _) * (f + 1))),
                u + p < 1 ? (r[m] = d[$] * (1 - u - p) + d[$ + 2] * u + d[$ + 2 * (f + 1)] * p, r[m + 1] = d[$ + 1] * (1 - u - p) + d[$ + 3] * u + d[$ + 2 * (f + 1) + 1] * p) : (r[m] = d[$ + 2 * (f + 1) + 2] * (u - 1 + p) + d[$ + 2 * (f + 1)] * (1 - u) + d[$ + 2] * (1 - p), r[m + 1] = d[$ + 2 * (f + 1) + 3] * (u - 1 + p) + d[$ + 2 * (f + 1) + 1] * (1 - u) + d[$ + 3] * (1 - p))
            },
            ...
            ot.prototype.drawElements = function(t, e, i, r, o, n, s, _) {
                try {
                    ...
                    v = 0; v < h; v += 3) {
                        ...
                        } else at.IGNORE_CLIP || ot.clip(u, y, n, k, O, b, R, F, C, N, M, x, A, w, I, D),
            ...
            at.setupProfile = function(t, e) {
                ...
                for (var i in arguments.length < 2 && (e = !0), e && console.log("profile : " + t.PROFILE_NAME), t) at[i] = t[i],
                e && console.log("  [" + i + "] = " + t[i])
            },
            at.init = function() {
                if (at._$6b) {
            ...
            dt._$cr = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = dt._$9r(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            dt._$mb = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = dt._$vb(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            dt._$Hs = function() {
                return this._$Gr
            ...
            Et.setup = function() {
                ...
                if ((t = e.indexOf("iPhone OS ")) >= 0) r.os = "iPhone",
                r._isIPhone = !0,
    ...
    81 : function(t, e, i) {
        ...
        p.load = function(t) {
            for (var e = new p,
            i = d.getPlatformManager().jsonParseFromBytes(t).physics_hair, o = i.length, n = 0; n < o; n++) {
                var s = i[n],
                a = new r.PhysicsHair,
                _ = s.setup,
        ...
        c.load = function(t) {
            for (var e = new c,
            i = d.getPlatformManager().jsonParseFromBytes(t).parts_visible, r = i.length, o = 0; o < r; o++) {
        ...
        t.exports = {
            createDialogElement: function(t) {
                if (($ = document.createElement("div")).className = "live2d-widget-dialog-container", $.style.transform = "scale(" + r.config.display.width / 250 + ")", (u = document.createElement("div")).className = "live2d-widget-dialog", $.appendChild(u), t.appendChild($), n.L2Dwidget.emit("create-dialog", $), r.config.dialog.script) {
                    ...
                    e.registerEmitter("every", (0, s.everyEmitter)(e)),
                    e.registerEmitter("hover", (0, a.hoverEmitter)()),
                    e.registerEmitter("tap body", (0, _.tapbodyEmitter)(n.L2Dwidget)),
                    e.registerEmitter("tap face", (0, h.tapfaceEmitter)(n.L2Dwidget)),
        ...
        var n = function(t) {
            ...
            },
            {
                ...
                value: function(t) {
                    ...
                    r = t,
                    o = null,
                    n = []; null !== (o = i.exec(t));) n.push(o);
                    var s = n.map(function(t) {
                        var i = e.matchVariable(t[1]);
                        if (!i) throw new Error("Unknown variable: " + t[1]);
                        var o = i.func();
            ...
            everyEmitter: function(t) {
                return function(e, i) {
                    ...
                    var n = function(t) {
                        ...
                        o = t.toLowerCase(),
                        n = 0;
                        return e.test(o) ? (e.lastIndex = 0, n = 1e3 * parseInt(e.exec(o)[1])) : i.test(o) ? (i.lastIndex = 0, n = parseInt(i.exec(o)[1])) : r.test(o) && (r.lastIndex = 0, n = 60 * parseInt(r.exec(o)[1]) * 1e3),
                        n
                    } (r);
                    if (n) {
                        var s = null,
                        a = function t() {
                            s = null,
                            i(),
                            o || (s && clearTimeout(s), s = setTimeout(t, n))
                        };
                        t.on("emit",
                        function() {
                            o && (s && clearTimeout(s), s = setTimeout(a, n))
                        }),
                        a()
                    }
                }
